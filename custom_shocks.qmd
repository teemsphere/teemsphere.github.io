...
[Here](https://github.com/teemsphere/teems-scripts/blob/main/GTAP-REv1/v11_cst_fullvar_df_year.R) (and see snippets below) is a demonstration of 4 custom shocks carried out on all variable tuples for a range of variable dimensions with the [GTAP-RE](https://github.com/teemsphere/teems-models/tree/main/GTAP-REv1) model.
