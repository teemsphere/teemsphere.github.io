...
With more complex models it is often necessary to load auxiliary data.
There are also cases were users may wish to directly modify headers in existing base data.
...
In the below notation, hat (ˆ) indicates the new parameter value while asterisk (*) indicates the destination set.
mapping.
