...
To use a classic-based model with a newer v7.0 database, or a standard model with an older v6.2 database, use `GTAP_convert()` to convert the data first.
The returned list can be passed directly to `ems_data()`.
