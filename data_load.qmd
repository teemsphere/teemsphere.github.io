...
|------------------------|--------|----------------------------------------------------------------|----------------------------------------------------------------------|
| **Param.**             |        |                                                                 |                                                                      |
| $\sigma_\text{d}$  | ESBD   | Armington CES for domestic/imported allocation                  | $i \in \text{TRAD_COMM}$                                             |
| $\sigma_\text{m}$  | ESBM   | Armington CES for regional allocation of imports                | $i \in \text{TRAD_COMM}$                                             |
| $\sigma_\text{va}$ | ESBV   | CES between primary factors in production                       | $j \in \text{ALL_INDS},\ r \in \text{REG}$                           |
