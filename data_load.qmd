...
```r
v7_data <- ems_data(dat_input = "path/to/v7_data/v11c/flexAgg11c17/gsdfdat.har", # basedata coefficients
                    par_input = "path/to/v7_data/v11c/flexAgg11c17/gsdfpar.har", # parameter coefficients
                    set_input = "path/to/v7_data/v11c/flexAgg11c17/gsdfset.har", # set elements
                    REG = "big3",
                    COMM = "macro_sector",
                    ACTS = "macro_sector",
                    ENDW = "labor_diff"
...
* region (e.g., REG)
  ...
  + R32 (IIASA-based [SSP mapping](https://tntcat.iiasa.ac.at/SspDb/dsd?Action=htmlpage&page=10))
  + medium
  + large
  + full
...
data <- ems_data(dat_input = "path/to/v62_data/v10A/flexagg10AY14/gsddat.har",
                 ...
                 TRAD_COMM = "services",
                 ENDW_COMM = "labor_agg",
                 time_steps = c(0, 1, 2, 3, 4, 6, 8, 10, 12, 14, 16) # explicit time steps (equivalent to c(2014, 2015, 2016, 2017, 2018, 2020, 2022, 2024, 2026, 2028, 2030))
)
```
...
data <- ems_data(dat_input = "path/to/v7_data/v11c/flexAgg11c17/gsdfdat.har",
                 ...
                 ACTS = "medium",
                 ENDW = "labor_diff",
                 time_steps = c(2017, 2018, 2020, 2022, 2024, 2026, 2028, 2030) # chronological time steps (note reference year of input data)
) 
```
## Converting formats
