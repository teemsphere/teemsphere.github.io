...
## Closure selection
Standard model-specific closures are available within the model repository: [teems-models](https://github.com/teemsphere/teems-models). The general format consistens of:
